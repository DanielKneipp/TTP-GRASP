...
class TTPInstance : public Problem< TTPSolution >
{
private:
    /**
     ...
     */
    void removeWorstItemsWhileInvalid( TTPSolution& individual );
...
public:    
     ...
     *                      are not allocated.
     */
    TTPInstance( const std::string& fileName = std::string( "" ) );
    /**
     ...
     */
    void evaluateSolution( TTPSolution& ndividual );
    /**
     ...
     */
    bool isValidSolution( TTPSolution& individual );
};
